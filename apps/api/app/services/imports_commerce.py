...
async def _build_commerce_import_plan(
    ...
    *,
    ...
    existing_attributes_by_code = {_norm_attribute_code(item["code"]): item for item in all_attributes}
    existing_attributes_by_id = {item["id"]: item for item in all_attributes}
