...
def _serialize_guest_profile(model) -> dict[str, object]:
    return {
        ...
        "vip": model.vip,
        "preferred_room_type_id": model.preferred_room_type_id,
...
def _serialize_reservation(model) -> dict[str, object]:
    return {
        ...
        "guest_customer_id": model.guest_customer_id,
...
def _serialize_guest_document(model) -> dict[str, object]:
    return {
        "id": model.id,
        "tenant_id": model.tenant_id,
        "guest_profile_id": model.guest_profile_id,
...
def create_room_type(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=model.id,
        metadata={"property_id": property_id, "code": code},
    )
    db.commit()
...
def create_room(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=model.id,
        metadata={"property_id": property_id, "room_number": room_number},
    )
    db.commit()
...
def create_guest_document(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=guest_document.id,
        metadata={"guest_profile_id": guest_profile_id, "document_kind": document_kind},
    )
    db.commit()
...
def create_rate_plan(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=rate_plan.id,
        metadata={"property_id": property_id, "room_type_id": room_type_id, "label": label},
    )
    db.commit()
...
def create_availability_rule(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=availability_rule.id,
        metadata={"property_id": property_id, "room_type_id": room_type_id},
    )
    db.commit()
    ...
    *,
    ...
    _audit(
        ...
        metadata={
            "from_room_id": from_room.id,
            "to_room_id": to_room.id,
            "from_room_type_id": from_room.room_type_id,
            "to_room_type_id": to_room.room_type_id,
            "reason": reason,
        },
    )
    _outbox_reservation(db, tenant_id=tenant.id, reservation=reservation, event_status=reservation.status)
...
def add_folio_charge(
    ...
    *,
    ...
    _audit(
        ...
        metadata={"folio_id": folio.id, "category": category, "gross_amount_minor": line_amount_minor + tax_amount_minor},
    )
    db.commit()
...
def record_payment(
    ...
    *,
    ...
    _audit(
        ...
        metadata={"folio_id": folio.id, "amount_minor": amount_minor, "payment_method": payment_method},
    )
    db.commit()
    return get_folio_detail(db, tenant_slug=tenant_slug, folio_id=folio_id)
...
def record_refund(
    ...
    *,
    ...
    _audit(
        ...
        metadata={"folio_id": folio.id, "payment_id": payment.id, "amount_minor": amount_minor},
    )
    db.commit()
    return get_folio_detail(db, tenant_slug=tenant_slug, folio_id=folio_id)
...
def close_folio(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=folio.id,
        metadata={"reservation_id": folio.reservation_id},
    )
    db.commit()
    return get_folio_detail(db, tenant_slug=tenant_slug, folio_id=folio_id)
...
def issue_folio_invoice(
    ...
    *,
    ...
    _audit(
        ...
        subject_type="hotel_folio",
        subject_id=folio.id,
        metadata={"invoice_number": folio.invoice_number, "reservation_id": folio.reservation_id},
    )
...
def create_staff_member(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=staff_member.id,
        metadata={"property_id": property_id, "staff_code": staff_code, "department": department},
    )
    db.commit()
...
def create_shift(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=shift.id,
        metadata={"property_id": property_id, "staff_member_id": staff_member_id, "shift_kind": shift_kind},
    )
    db.commit()
...
def run_night_audit(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=audit.id,
        metadata={"property_id": property_id, "audit_date": audit_date.isoformat(), "status": audit_status},
    )
    db.commit()
...
def update_reservation_status(
    ...
    *,
    ...
    _audit(
        ...
        subject_type="hotel_reservation",
        subject_id=reservation.id,
        metadata={"status": reservation.status, "room_id": room.id if room else None},
    )
    _outbox_reservation(db, tenant_id=tenant.id, reservation=reservation, event_status=reservation.status)
    db.commit()
    return _serialize_reservation(reservation)
...
def create_housekeeping_task(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=task.id,
        metadata={"room_id": room_id, "priority": priority, "assigned_staff_id": assigned_staff_id},
    )
    db.commit()
...
def update_housekeeping_status(
    ...
    *,
    ...
    _audit(
        ...
        subject_type="hotel_housekeeping_task",
        subject_id=task.id,
        metadata={"status": status, "room_id": room.id},
    )
    db.commit()
    return _serialize_housekeeping_task(task)
...
def update_maintenance_status(
    ...
    *,
    ...
    _audit(
        ...
        subject_type="hotel_maintenance_ticket",
        subject_id=ticket.id,
        metadata={"status": status, "room_id": ticket.room_id},
    )
    db.commit()
    return _serialize_maintenance_ticket(ticket)
...
def upsert_amenity_catalog(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=property_id,
        metadata={"property_id": property_id, "category_count": len(amenity_payload["categories"])},
    )
    db.commit()
...
def upsert_nearby_places(
    ...
    *,
    ...
    _audit(
        ...
        subject_id=property_id,
        metadata={"property_id": property_id, "place_count": len(nearby_payload["places"])},
    )
    db.commit()
